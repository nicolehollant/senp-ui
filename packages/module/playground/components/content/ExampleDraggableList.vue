<template>
  <div class="grid grid-cols-2 gap-4">
    <div
      ...
      class="grid gap-4 grid-rows-[auto,minmax(0,1fr)] h-full"
    >
      <h3 class="text-xl">
        {{ key }}
      </h3>
      ...
      >
        <template #item="{ element }">
          <SenpCard
            ...
            :classes="{
              wrapper: {
                extend: key === 'Done' ? 'opacity-50 !bg-gray-950' : '',
              },
            }"
            type="header"
            :title="element.title"
  ...
  "In Progress": [
    {
      ...
      description:
        "Eveniet a a officiis eum. Aut labore praesentium praesentium. Possimus iusto tenetur.",
    },
    {
  ...
  Done: [
    {
      ...
      description:
        "Similique vero vitae aut magnam. Illo voluptate cumque possimus amet aliquid.",
    },
    {
