  ...
  <HeadlessMenu as="div" class="relative inline-block text-left">
    <div>
      ...
      >
        ...
        <Icon
          ...
          class="ml-2 -mr-1 h-5 w-5 text-violet-200 hover:text-violet-100 transform transition duration-200"
    ...
    >
      ...
      >
        <div class="px-1 py-1">
          <slot name="items">
            <HeadlessMenuItem v-slot="{ active }" v-for="option in options" :key="option">
              <button
                :class="[
