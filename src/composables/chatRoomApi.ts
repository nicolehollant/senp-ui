...
const BASEURL = "https://crudify.app/api/user/iTduz8WS9Cug4-cH/crudifyChatRoom";
...
export const chatRoomQueryKeys = {
  ...
  getAll: ["chatRoom", "getAll"],
  match: ["chatRoom", "match"],
  getOneByID: ["chatRoom", "getOneByID"],
  deleteOneByID: ["chatRoom", "deleteOneByID"],
  updateOne: ["chatRoom", "updateOne"],
};
